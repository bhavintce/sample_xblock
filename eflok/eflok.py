...
class EflokXBlock(XBlock):
    ...
    def student_view(self, context=None):
        """
        The primary view of the EflokXBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/eflok.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/eflok.css"))
        frag.add_javascript(self.resource_string("static/js/src/eflok.js"))
        frag.initialize_js('EflokXBlock')
        return frag
